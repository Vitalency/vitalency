<template>
  <div>
    ...
    <p>
      ...
      Privacy applies to https://teamvitalency.com and Vitalency, LLC. and
      governs data collection and usage. For the purposes of this Privacy
      Policy, unless otherwise noted, all references to Vitalency, LLC. include
      https://teamvitalency.com and Vitalency. The Vitalency website is a health
      coaching site. By using the Vitalency website, you consent to the data
    ...
    <p>
      ...
      Site, Vitalency may collect personally identifiable information, such as
      your:
    </p>
    ...
    <p>
      Vitalency may also collect anonymous demographic information, which is not
    ...
    <p>
      ...
      information or personally sensitive data through Vitalency's public
    ...
    <p>
      ...
      an account on our Site; (b) entering a sweepstakes or contest sponsored by
      ...
      card or other payment information when ordering and purchasing products
      and services on our Site. To wit, we will use your information for, but
    ...
    <p>
      Vitalency collects and uses your personal information to operate its
      website(s) and deliver the services you have requested.
    </p>

    <p>
      Vitalency may also use your personally identifiable information to inform
      you of other products or services available from Vitalency and its
      affiliates.
    </p>
    ...
    <p>
      ...
      your personal information except to provide these services to Vitalency,
      and they are required to maintain the confidentiality of your information.
    </p>

    <p>
      Vitalency may disclose your personal information, without notice, if
      ...
      process served on Vitalency or the site; (b) protect and defend the rights
      or property of Vitalency; and/or (c) act under exigent circumstances to
      protect the personal safety of users of Vitalency, or the public.
    </p>

    <h2>Tracking User Behavior</h2>

    <p>
      Vitalency may keep track of the websites and pages our users visit within
      Vitalency, in order to determine what Vitalency services are the most
      popular. This data is used to deliver customized content and advertising
      within Vitalency to customers whose behavior indicates that they are
      interested in a particular subject area.
    </p>

    <p>
      Vitalency may track user interactions on our websites and pages in order
    ...
    <p>
      ...
      collected by Vitalency. This information can include: your IP address,
      ...
      the Vitalency website.
    </p>

    <h2>Use of Cookies</h2>

    <p>
      The Vitalency website may use "cookies" to help you personalize your
    ...
    <p>
      ...
      you have returned to a specific page. For example, if you personalize
      Vitalency pages, or register with Vitalency site or services, a cookie
      helps Vitalency to recall your specific information on subsequent visits.
      ...
      the same Vitalency website, the information you previously provided can be
      retrieved, so you can easily use the Vitalency features that you
      customized.
    </p>
    ...
    <p>
      ...
      of the Vitalency services or websites you visit.
    </p>
    ...
    <p>
      Vitalency secures your personal information from unauthorized access, use,
    ...
    <p>
      Vitalency does not knowingly collect personally identifiable
      informationfrom children under the age of thirteen. If you are under the
      age of thirteen, you must ask your parent or guardian for permission to
      use this website.
    </p>

    <h2>Disconnecting your Vitalency Account from Third Party Websites</h2>

    <p>
      You will be able to connect your Vitalency account to third party
      accounts. BY CONNECTING YOUR VITALENCY ACCOUNT TO YOUR THIRD PARTY
      ...
      account from a third party account at any time. Users may learn how to
    ...
    <p>
      From time to time, Vitalency may contact you via email for the purpose of
      ...
      Vitalency or click on a link therein.
    </p>

    <p>
      If you would like to stop receiving marketing or promotional
      communications via email from Vitalency, you may opt out of such
      communications by Customers may unsubscribe from emails by clicking the
      "Unsubscribe" link..
    </p>
    ...
    <p>
      Vitalency reserves the right to change this Privacy Policy from time to
    ...
    <p>
      Vitalency welcomes your questions or comments regarding this Statement of
      Privacy. If you believe that Vitalency has not adhered to this Statement,
